...
public partial class Index
{
    ...
    private async Task LoadAndVerifyUser()
    {
        ...
        if (String.IsNullOrWhiteSpace(objectId) == false)
        {
            ...
            if (objectId.Equals(loggedInUser.FirstName) == false)
            {
                isDirty = true;
                loggedInUser.FirstName = firstName;
            }

            if (objectId.Equals(loggedInUser.LastName) == false)
            {
                isDirty = true;
                loggedInUser.LastName = lastName;
            }

            if (objectId.Equals(loggedInUser.DisplayName) == false)
            {
                isDirty = true;
                loggedInUser.DisplayName = displayName;
            }

            if (objectId.Equals(loggedInUser.EmailAddress) == false)
            {
                isDirty = true;
    ...
    private string SortedByNewClass(bool isNew) => isNew == isSortedByNew ? "sort-selected" : "";
